 ...
 * *****************************************************************************
 */
public class CustomGestureDetector implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public CustomGestureDetector(Context context, OnScaleDragGestureListener scaleDragGestureListener) {
